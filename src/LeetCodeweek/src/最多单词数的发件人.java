...
/**
 * @author: MC
 * @Pcakage: PACKAGE_NAME.最多单词数的发件人
 * @Date: 2022年05月31日 15:46
 * @Description:给你一个聊天记录，共包含 n 条信息。给你两个字符串数组 messages 和 senders ，其中 messages[i] 是 senders[i] 发出的一条 信息 。
 * <p>
...
public class 最多单词数的发件人 {
    public String largestWordCount(String[] messages, String[] senders) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            map.put(senders[i], map.getOrDefault(senders[i], 0) + split.length);
        }
        int max = 0;
        String maxname = " ";
